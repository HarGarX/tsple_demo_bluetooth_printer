...
public class Activity_PRNFile extends Activity 
{
	...
	private int a[] = {R.drawable.icon_folder,R.drawable.ic_file_pdf,R.drawable.icon_file_image};
	...
	private void list_files(){
		...
		Log.d("Print", "list_files: "+ Arrays.toString(FolderPath.list()));
		fill(file);		
	}
